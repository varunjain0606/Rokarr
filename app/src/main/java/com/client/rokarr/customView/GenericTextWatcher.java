...
/**
 * Created by Varun on 16-11-2015.
 */
public class GenericTextWatcher implements TextWatcher {
    ...
    Fragment fragment;
    Context context;
    public GenericTextWatcher(OneFragment fragment, View view) {
            ...
            case R.id.NetAmount:
                ...
                else if(!mainFragment.balance.getText().toString().equals(""))
                {
                    ...
                    if(!mainFragment.amount.getText().toString().equals("")) {
                        ...
                        {
                            value = databaseHandler.getBalance(mainFragment.names.getText().toString(),1);
                        }
